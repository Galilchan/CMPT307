...
<body>
		...
		<center><h1 style="color:black;">Delete Rows</center>
		<br>
...
<center><h3 style="color:black;">Remember proper syntax!</center>
	...
	DELETE FROM <select name="table"> 
 	...
 	WHERE <input type="text" name="values" placeholder=" Type new data..." maxlength="200" size="50" style="min-width:100px; min-height: 30px;"/>
	<br>
...
<?php 
if (isset($_POST['table']) AND isset($_POST['values'])) {
...
$query=$pdo->query("DELETE FROM $table WHERE $values");

print "<CENTER><font color='green'>Values succesfully deleted!</font></CENTER>";
